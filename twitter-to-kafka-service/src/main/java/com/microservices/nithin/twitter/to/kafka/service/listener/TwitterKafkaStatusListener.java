package com.microservices.nithin.twitter.to.kafka.service.listener;
...
import com.microservices.nithin.twitter.to.kafka.service.transformer.TwitterStatusToAvroTransformer;
...
public class TwitterKafkaStatusListener extends StatusAdapter {
    ...
    public void onStatus(Status status) {
        LOGGER.info("Twitter status with text {} to kafka topic {}",status.getText(),kafkaConfigData.getTopicName());
